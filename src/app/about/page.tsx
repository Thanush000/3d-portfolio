...
const CONTACT_LINKS = [
  {
    name: "Email",
    content: "contact@kthanush.dev",
    href: "mailto:contact@kthanush.dev",
  ...
  {
    name: "LinkedIn",
    href: "https://www.linkedin.com/in/thanush000/",
    content: "/thanush000",
    icon: <FaLinkedin height={"50px"} />,
  },
  {
    name: "GitHub",
    href: "https://github.com/Thanush000",
    content: "/Thanush000",
          ...
          >
            <div className="flex flex-row lg:flex-col items-center">
              ...
              <div className="flex flex-col gap-3 lg:items-center ml-10 md:ml-20 lg:ml-0">
                <p className="text-center text-xl">K Thanush</p>
        ...
        <main className="basis-3/4 w-[500px]">
          ...
          >
            ...
            <p className="mb-10 text-roboto">
              Hey there! I&apos;m K Thanush, a Full Stack developer passionate about
              creating meaningful digital experiences and innovative solutions.
              Creator of Acadexis and various web applications, I thrive on turning
              ideas into reality through clean code and elegant design. My journey
              began with a fascination for technology and a drive to make a positive
              impact through software.
            </p>
            <p className="mb-10">
              When I&apos;m not coding, you can find me exploring new technologies,
              learning about AI and machine learning, or working on exciting side
