...
using use = useUsing("use")`,
  ...
  [SkillNames.JAVA]: {
    ...
    name: "java",
    label: "Java",
    shortDescription: "Write once, run anywhere - the OG cross-platform legend! ☕💻",
    color: "#007396",
  ...
  [SkillNames.UIUX]: {
    ...
    name: "uiux",
    label: "UI/UX Design",
    shortDescription: "Where beautiful meets functional - designing experiences that click! 🎨✨",
    color: "#FF6B6B",
    icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/figma/figma-original.svg",
  },
  [SkillNames.WIREFRAMING]: {
    id: 27,
    name: "wireframing",
    label: "Wireframing & Prototyping",
    shortDescription: "From sketch to reality - blueprinting digital dreams! 📐🚀",
    color: "#9B59B6",
  ...
  [SkillNames.KAGGLE]: {
    ...
    name: "kaggle",
    label: "Kaggle",
    shortDescription: "Where data scientists compete and ML models thrive! 📊🏆",
    color: "#20BEFF",
  ...
  [SkillNames.KIRO]: {
    ...
    name: "kiro",
    label: "Kiro",
    shortDescription: "Leveling up productivity with cutting-edge tools! 🛠️⚡",
    color: "#00D9FF",
  ...
  [SkillNames.ANTIGRAVITY]: {
    ...
    name: "antigravity",
    label: "Antigravity",
    shortDescription: "AI-powered coding assistant that takes development to new heights! 🚀🤖",
    color: "#6366F1",
...
export const EXPERIENCE: Experience[] = [
  {
    ...
    startDate: "2023",
    endDate: "Present",
    title: "Full Stack Developer (Student / Fresher)",
    company: "UI/UX Designer | Full Stack Developer | Vibe Coder - Hyderabad, Telangana",
    description: [
      "Developed responsive web applications using modern front-end and back-end technologies",
      "Designed intuitive UI/UX layouts to enhance usability and accessibility",
      "Built full-stack features including authentication, dashboards, and API integrations",
      "Worked with JavaScript frameworks and backend services to handle real-world use cases",
    ],
    skills: [
      SkillNames.HTML,
      SkillNames.CSS,
