...
export const EXPERIENCE: Experience[] = [
  {
    ...
    startDate: "2023",
    endDate: "Present",
    title: "Student Developer (Fresher)",
    company: "Hyderabad, Telangana",
    description: [
      "Developed responsive web interfaces using HTML, CSS, JavaScript, and React",
      "Designed user-friendly UI/UX layouts using Figma and modern design principles",
      "Built academic and personal projects applying real-world development practices",
      "Improved problem-solving skills by implementing features from concept to deployment",
      "Collaborated with peers on projects and participated in technical discussions",
    ],
    skills: [
      SkillNames.HTML,
      SkillNames.CSS,
